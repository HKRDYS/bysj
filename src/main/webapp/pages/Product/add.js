layui
    ...
    .use(
        ['form', 'layer', 'jquery', 'layedit', 'laydate', 'upload', 'element'],
        function () {
            var form = layui.form, layer = layui.layer, laypage = layui.laypage, layedit = layui.layedit,
                laydate = layui.laydate, $ = layui.jquery, upload = layui.upload,element = layui.element;
            ...
            var uploadVideo = upload
                .render({
                    ...
                    accept: 'file',
                        ...
                        element.progress('videoprogress', percent + '%');
                    },
                    error: function () {
                        // 演示失败状态，并实现重传
                        var demoText = $('#demoText');
            ...
            //获取信息
            if (id != null && id != '') {
                $.getJSON(ctxPath + "/product/get", "id=" + id, function (jsondata) {
