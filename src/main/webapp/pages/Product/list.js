                ...
                table.on('tool(listtable)', function (obj) {
                    ...
                    if (obj.event === 'del') {
                        layer.confirm('你确认删除这条数据吗?', function (index) {
                            $.getJSON(ctxPath + "/product/del", idDatas,
                                function (jsondata) {
...
//	
//	
// $.get(ctxPath+"/product/list", function(data){
// newsData=data;
// //执行加载数据的方法
// newsList();
// })
