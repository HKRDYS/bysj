	...
	layui
			...
			.use(
					...
					function() {
						...
						table.render({
							elem : '#list',
							skin: 'line' //行边框风格,row,nob
							,even: true //开启隔行背景
							,size: 'lg' //小尺寸的表格sm,lg
							,
							url : ctxPath + '/dic/list' // 数据接口
							,
							cols : [ [ // 表头
							{
								type : 'checkbox',
						...
						table.on('tool(listtable)', function(obj) {
							...
							if (obj.event === 'del') {
								layer.confirm('你确认删除这条数据吗?', function(index) {
									$.getJSON(ctxPath + "/dic/del", idDatas,
											function(jsondata) {
...
//	
//	
// $.get(ctxPath+"/dic/list", function(data){
// newsData=data;
// //执行加载数据的方法
// newsList();
// })
